...
// Assume controls are passed as a prop from Inertia
interface Control {
    id: number;
    name: string;
    limit: string;
...
export default function AssetCreate({ controls }: AssetCreateProps) {
    ...
    const [controlFields, setControlFields] = useState<number[]>([]);
