...
export default function ControlTypesCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('control-types.store'));
    };
    ...
    return (
        <DashboardLayout>
            <Head title="Create Control Type" />
            ...
            <Box sx={{ p: { xs: 2, md: 3 } }}>
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <Typography variant="body1" color="text.secondary">
                        Add a new control type to organize your controls
                    </Typography>
                </Box>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12}>
                                ...
                                >
                                    ...
                                    >
                                        {processing ? 'Creating...' : 'Create Control Type'}
                                    </Button>
                                </Box>
                            </Grid>
                        </Grid>
